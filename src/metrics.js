...
function Metrics() {
  ...
  /*me.exportedBuildEstimatedChargesMetricsData = function(accountId, region) {
    me.accountId = accountId;
    me.localInput.region = region;
    me.remoteInput.region = region;

    var flows = [
      {func:buildEstimatedChargesMetricsData, success:succeeded, failure:failed, error:errored},
    ]
